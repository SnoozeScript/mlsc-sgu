...
import { 
  ArrowLeft, Trophy, Users, Presentation, Video, FileText, 
  Image, MapPin, Star, Quote, ChevronLeft, ChevronRight 
} from 'lucide-react';
  ...
  const summitHighlights = [
    {
      ...
      description: "A groundbreaking presentation exploring the intersection of artificial intelligence, machine learning, and ethical technology development."
    },
    {
      title: "Panel: Responsible AI Deployment",
      speakers: ["Dr. Elena Rodriguez", "Michael Chen", "Sarah Thompson"],
      description: "Leading experts discussed the critical challenges and opportunities in implementing AI technologies across various industries."
    },
    {
      title: "Workshop: Advanced Machine Learning Techniques",
      speaker: "Prof. James Wu, Stanford University",
      description: "An intensive deep-dive into cutting-edge machine learning algorithms and their practical applications in real-world scenarios."
    }
  ];
  ...
  const attendeeTestimonials = [
    {
      ...
      quote: "An incredible event that provided deep insights into the latest AI technologies and ethical considerations.",
      rating: 5
    },
    {
      name: "Sarah Miller",
      role: "AI Research Lead, InnovateAI",
      quote: "The workshops were extremely practical, offering real-world applications of advanced machine learning techniques.",
      rating: 5
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-12">
            <button className="flex items-center text-cyan-400 hover:text-cyan-300 mb-4">
            ...
            <p className="text-gray-400 text-xl">
              A landmark event exploring the frontiers of data science and artificial intelligence
            </p>
          </div>

          {/* Event Overview */}
          <section className="bg-gray-800 rounded-2xl p-8 mb-12">
            <h2 className="text-3xl font-bold mb-6 text-cyan-400">Event Highlights</h2>
          ...
          <section className="mb-12">
            <div className="bg-gray-800 rounded-2xl p-8">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-3xl font-bold text-cyan-400">Event Gallery</h2>
          ...
          {/* Event Location */}
          <section className="bg-gray-800 rounded-2xl p-8 mb-12">
            <h2 className="text-3xl font-bold mb-6 text-cyan-400">Event Location</h2>
